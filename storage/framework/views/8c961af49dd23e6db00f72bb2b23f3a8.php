...
<div class="message-card <?php if($isSender): ?> mc-sender <?php endif; ?>" data-id="<?php echo e($id); ?>">
    ...
    <div class="message-card-content">
        ...
        <div class="image-wrapper" style="text-align: <?php echo e($isSender ? 'end' : 'start'); ?>">
            <div class="image-file chat-image" style="background-image: url('/storage/attachments/<?php echo e($attachment->file); ?>')">
...
<?php /**PATH C:\wamp64\www\TwansaMessenger\resources\views/vendor/Chatify/layouts/messageCard.blade.php ENDPATH**/ ?>