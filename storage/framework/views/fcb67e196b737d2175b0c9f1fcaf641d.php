...
<?php if($get == 'saved'): ?>
    <table class="messenger-list-item" data-contact="<?php echo e(Auth::user()->id); ?>">
        <tr data-action="0">
            ...
            <td>
              </p><div class="avatar av-s header-avatar" style="margin: 0px 10px; margin-bottom: -5px; margin-right: 5px"></div>
           
            
            </td>
            
            <td>
                <p data-id="<?php echo e(Auth::user()->id); ?>" data-type="user">My space  <span>You</span></p>
...
<?php /**PATH C:\wamp64\www\TwansaMessenger\resources\views/vendor/Chatify/layouts/listItem.blade.php ENDPATH**/ ?>