...
//video call model [cancel button]
$(".app-modal[data-name=settings]")
  .find(".app-modal-footer .cancel")
  .on("click", function () {
...
function startVideoCall() {
  // Your code to initiate the video call using WebRTC
  // This may involve creating a video element, capturing media streams, and establishing connections with the remote participant(s)
}

// Function to end the video call
function endVideoCall() {
  // Your code to terminate the video call
  // This may involve closing connections, stopping media streams, and removing the video element
}

// Function to handle canceling the updating of the avatar
function cancelUpdatingAvatar() {
  // Your code to handle canceling the updating of the avatar
  // This may involve reverting any changes made or displaying a message to the user
}
